    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                doc.TextDefaults.AppliedFont = "Minion Pro";
                doc.Save(saveFile, false, "bot generated", false);
                double pgWidth = 5.6;
                double pgHeight = 11;
                ...
                /*doc.MarginPreferences.Top = 0.15;
                doc.MarginPreferences.Left = 0.15;
                doc.MarginPreferences.Bottom = 0.15;
                doc.MarginPreferences.Right = 0.15;*/
                ...
                for (int j = 0; j < textFrame.Paragraphs.Count; j++)
                {
                    ...
                    paragraphs.MoveNext();
                    InDesign.Paragraph paragraph = ((InDesign.Paragraph)paragraphs.Current);
                    paragraph.Justification = InDesign.idJustification.idCenterAlign;
                ...
                Console.WriteLine("created document"+ doc.Conditions);
                ...
                response = response.Replace("message", "document created and saved @ " + saveFile);
              //  doc.Close();
